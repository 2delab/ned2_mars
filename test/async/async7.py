...
print("=" * 80)
print("ASYNC DUAL-ARM EXECUTION - UNIFIED PLANNING + SEPARATE EXECUTION")
print("=" * 80 + "\n")

# Create SINGLE MoveItPy instance for BOTH arms (planning only)
...
print("NOTE: Planning occurs in SAME unified scene.")
print("      Both arms plan with collision awareness of each other.\n")

# Create identical pose goal
print("[3/6] Planning both arms to identical pose (collision-aware)...\n")
...
if plan_result_1 and plan_result_2:
    ...
    print("[4/6] Creating separate execution contexts for each arm...\n")

    # Create SEPARATE MoveItPy instances for EXECUTION ONLY
    # This allows thread-safe parallel execution
    ...
    print("✓ Separate execution contexts created\n")

    print("[5/6] Executing both arms in parallel...\n")
    ...
    print("\nCollision Safety:")
    print("  ✓ COLLISION-FREE (guaranteed by unified planning scene)")
    print("    - Both arms planned in same scene (collision-aware)")
    print("    - Executed in separate threads (thread-safe)\n")
