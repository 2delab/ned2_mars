...
print("=" * 80)
print("ASYNC DUAL-ARM EXECUTION - WITH DYNAMIC COLLISION SYNCHRONIZATION")
print("=" * 80 + "\n")

# Create TWO separate MoveItPy instances (one per arm)
print("[1/5] Creating two separate MoveItPy instances...\n")
...
print("[2/5] Getting planning components...\n")
...
print("[3/5] Planning both arms to identical pose...\n")
...
print("[4/5] Synchronizing collision objects...\n")
...
if plan_result_1 and plan_result_2:
    ...
    print("[5/5] Executing both arms in parallel threads...\n")
