...
def main():
    ...
    # Set joint goals: joint_1 = 50 degrees, lock all others at 0
    constraints_list = []
    ...
    print(f"\nGoal state:")
    print(f"  joint_1 = 50° (Tolerance: ±5°)")
    print(f"  joint_2 through joint_6 = 0° (Tolerance: ±1° - locked in place)")
    ...
    if error_code == 1:  # SUCCESS
        ...
        print("  4. Robot moved joint_1 from 0° to 50° (target)")
        print("  5. Joints 2-6 remained locked at 0° (tight tolerance constraints)")
