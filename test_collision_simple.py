...
def main():
    ...
    # ========== PHASE 3: Move to collision zone ==========
    print("\nPHASE 3: Moving to collision zone...")
    print("  ARM_1: joint_1=-50°, joint_2=-35° (stays)")
    print("  ARM_2: joint_1=-50°, joint_2=-35° (stays)")
    print("  Watch RViz for potential collision...")

    # Compound trajectory: position 1 -> position 2
    # Position 2: {0: -50, 1: -35} (joint_1=-50°, joint_2=-35°)
    traj1 = create_compound_position_trajectory(
        "arm_1", [{0: 50, 1: -35}, {0: -50, 1: -35}], duration_per_move=3.0
    )
    traj2 = create_compound_position_trajectory(
        "arm_2", [{0: 50, 1: -35}, {0: -50, 1: -35}], duration_per_move=3.0
    )
    ...
    print("  ✓ Both moving to position 2 (parallel)")
    print("  Waiting for execution (~4 seconds)...")
    time.sleep(4)
    print("  ✓ Position 2 reached (collision zone)")

    # ========== PHASE 4: Return both to home ==========
    print("\nPHASE 4: Returning both arms to home...")
    home1 = create_home_trajectory("arm_1", duration_sec=3.0)
    home2 = create_home_trajectory("arm_2", duration_sec=3.0)
